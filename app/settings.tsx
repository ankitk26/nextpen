...
export default function Settings() {
	...
	const wrapChange = (e: React.ChangeEvent<HTMLInputElement>) =>
		setWrap(e.target.checked);
	const lineNumbersChange = (e: React.ChangeEvent<HTMLInputElement>) =>
	...
	return (
		<div className="grid w-full h-full grid-cols-2 p-8 mb-10 text-center bg-background">
			...
			<div className="mx-16 my-0 text-center">
				<h1 className="text-2xl text-white text-opacity-80">
					Settings
				</h1>
